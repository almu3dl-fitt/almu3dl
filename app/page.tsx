...
export default async function Home() {
  ...
  > = {
    nutrition: {
      ...
      description: nutritionRange
        ? `خيارات سعرات تبدأ من ${nutritionRange} سعرة لتسهيل تنظيم الأكل اليومي بشكل أوضح.`
    ...
    workouts: {
      ...
      description:
        'من برنامج المبتدئين إلى التحدي في النادي وبرامج مصممة لمن يريد الاستمرار حتى مع ضغط الوقت.',
  ...
  const featuredDescriptions: Record<string, string> = {
    'total-transformation':
      'اختيار شامل لمن يريد برنامجًا أكبر يربط بين الالتزام والخطة والانطلاق بشكل أوضح.',
    'flexible-diet-1500':
    ...
    'back-therapy':
      'تمارين علاجية رقمية تساعدك على التعامل مع آلام الظهر ضمن مسار أوضح وأسهل للالتزام.',
    'rehab-bundle':
      'باقة موجهة لمن يريد مسارًا علاجيًا أشمل يجمع أكثر من حل داخل خيار واحد.',
  }
  ...
  const goalCards = [
    ...
    },
    {
      ...
      description:
        'برنامج المشغول وقاطع التمرين مناسبين لمن يريد خطة تمرين أوضح بدون جداول مرهقة أو التزام معقد.',
    ...
    },
    {
      ...
      description:
        'خيارات علاجية وباقة تأهيل رياضي لمن يريد مسارًا مرتبًا أكثر عند البحث عن دعم حركي واضح.',
      href: '/store?category=therapy',
      cta: 'عرض الحلول',
    },
  ]
  ...
  return (
    <div className="home-shell storefront-shell">
          ...
          <article className="home-hero-main">
            <div className="home-hero-copy">
              ...
              <h1>
                ...
                <br />
                وابدأ بخطة أوضح من اليوم
              </h1>
              <p>
                في المعضل ستجد أنظمة غذائية مرنة، برامج تمارين، حلول علاجية،
                وباقات رقمية مرتبة لتسهّل عليك اختيار المسار المناسب لهدفك
        ...
        <section className="home-section">
          <div className="home-surface-panel">
            <StorefrontSectionHeading
              ...
              description="اختيارات مناسبة لتكوين انطباع أوضح عن نوع البرامج المتوفرة حاليًا داخل المتجر."
            />
              ...
              {featuredProducts.map(product => (
                <HomeFeaturedProductCard
                  ...
                  description={
                    ...
                    'خيار رقمي مرتب من المتجر يساعدك تبدأ بخطوة أوضح.'
                  }
          ...
          <div className="home-final-cta">
            <div>
              ...
              <p>
                ...
                أكثر ترتيبًا، المتجر جاهز ليعطيك مسارًا أوضح من أول نقرة.
              </p>
            </div>
      ...
      <StorefrontFooter note="واجهة عربية أوضح ومحتوى حقيقي مبني على كتالوج المتجر الحالي: تغذية، تمارين، علاجية، وباقات رقمية." />
    </div>
  )
}
